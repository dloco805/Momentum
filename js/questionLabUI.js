...
const QuestionLabUI = (() => {
            ...
            <section class="question-spark">
                ...
                <div class="card-actions">
                    ...
                    <button class="button button-secondary" type="button"
                        ...
                        data-question="${esc(state.currentQuestion)}">Add to Circle</button>
                    <button class="button button-secondary" type="button"
    ...
    function handleClick(event) {
        ...
        if (action === "another-question") {
            ...
            App.showToast("Question ready for a Circle.");
    ...
    return Object.freeze({ initialize, render, questionsForSituation });
})();
