    ...
    function cleanRecordArray(value, type) {
        ...
        return value
            ...
            .map((item) => ({
                ...
                linkedType: cleanString(item.linkedType) || "general",
                linkedItemId: cleanString(item.linkedItemId),
                linkedLabel: cleanString(item.linkedLabel),
                assignedTo: cleanString(item.assignedTo) || "Educator",
