...
const OpportunityManager = (() => {
    ...
    const LOCAL_EXPERIENCE_LIBRARY = [
        ...
        },
        {
                ...
                "organization": "City of Lompoc Parks & Recreation",
                "type": "Volunteer",
                "location": "Lompoc",
                "format": "In person",
        ...
        {
                "id": "EXP-JOBSEARCH",
                "title": "Local Part-Time Job Search",
                "organization": "Lompoc Community Directory",
                "type": "Employment",
                "location": "Lompoc",
                "format": "Student research",
                "url": "https://lompoc.com/",
                "description": "Choose businesses by category, check official career pages, and build a focused application list.",
                "eligibility": "Students confirm age requirements and current openings.",
                "tags": [
                        "jobs",
                        "applications"
                ],
        ...
        },
        {
                ...
                "format": "Outreach",
                "url": "https://lompoc.com/",
                "description": "Identify a local organization, prepare questions, and request a short workplace visit.",
                "eligibility": "Requires educator approval and organization confirmation.",
                "tags": [
                        "job shadow",
                        "outreach"
                ],
